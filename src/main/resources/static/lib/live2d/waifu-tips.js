...
// åŽç«¯æŽ¥å£
live2d_settings['modelAPI'] = '//live2d.fghrsh.net/api/';   // è‡ªå»º API ä¿®æ”¹è¿™é‡Œ
live2d_settings['tipsMessage'] = 'waifu-tips.json';            // åŒç›®å½•ä¸‹å¯çœç•¥è·¯å¾„
live2d_settings['hitokotoAPI'] = 'hitokoto.cn';                  // ä¸€è¨€ APIï¼Œå¯é€‰ 'lwl12.com', 'hitokoto.cn', 'jinrishici.com'(å¤è¯—è¯)

// é»˜è®¤æ¨¡åž‹
live2d_settings['modelId'] = 1;            // é»˜è®¤æ¨¡åž‹ IDï¼Œå¯åœ¨ F12 æŽ§åˆ¶å°æ‰¾åˆ°
live2d_settings['modelTexturesId'] = 53;           // é»˜è®¤æè´¨ IDï¼Œå¯åœ¨ F12 æŽ§åˆ¶å°æ‰¾åˆ°

// å·¥å…·æ è®¾ç½®
live2d_settings['showToolMenu'] = true;         // æ˜¾ç¤º å·¥å…·æ           ï¼Œå¯é€‰ true(çœŸ), false(å‡)
live2d_settings['canCloseLive2d'] = true;         // æ˜¾ç¤º å…³é—­çœ‹æ¿å¨˜  æŒ‰é’®ï¼Œå¯é€‰ true(çœŸ), false(å‡)
live2d_settings['canSwitchModel'] = true;         // æ˜¾ç¤º æ¨¡åž‹åˆ‡æ¢    æŒ‰é’®ï¼Œå¯é€‰ true(çœŸ), false(å‡)
live2d_settings['canSwitchTextures'] = true;         // æ˜¾ç¤º æè´¨åˆ‡æ¢    æŒ‰é’®ï¼Œå¯é€‰ true(çœŸ), false(å‡)
live2d_settings['canSwitchHitokoto'] = true;         // æ˜¾ç¤º ä¸€è¨€åˆ‡æ¢    æŒ‰é’®ï¼Œå¯é€‰ true(çœŸ), false(å‡)
live2d_settings['canTakeScreenshot'] = true;         // æ˜¾ç¤º çœ‹æ¿å¨˜æˆªå›¾  æŒ‰é’®ï¼Œå¯é€‰ true(çœŸ), false(å‡)
live2d_settings['canTurnToHomePage'] = true;         // æ˜¾ç¤º è¿”å›žé¦–é¡µ    æŒ‰é’®ï¼Œå¯é€‰ true(çœŸ), false(å‡)
live2d_settings['canTurnToAboutPage'] = true;         // æ˜¾ç¤º è·³è½¬å…³äºŽé¡µ  æŒ‰é’®ï¼Œå¯é€‰ true(çœŸ), false(å‡)

// æ¨¡åž‹åˆ‡æ¢æ¨¡å¼
live2d_settings['modelStorage'] = true;         // è®°å½• ID (åˆ·æ–°åŽæ¢å¤)ï¼Œå¯é€‰ true(çœŸ), false(å‡)
live2d_settings['modelRandMode'] = 'switch';     // æ¨¡åž‹åˆ‡æ¢ï¼Œå¯é€‰ 'rand'(éšæœº), 'switch'(é¡ºåº)
live2d_settings['modelTexturesRandMode'] = 'rand';       // æè´¨åˆ‡æ¢ï¼Œå¯é€‰ 'rand'(éšæœº), 'switch'(é¡ºåº)

// æç¤ºæ¶ˆæ¯é€‰é¡¹
live2d_settings['showHitokoto'] = true;         // æ˜¾ç¤ºä¸€è¨€
live2d_settings['showF12Status'] = true;         // æ˜¾ç¤ºåŠ è½½çŠ¶æ€
live2d_settings['showF12Message'] = false;        // æ˜¾ç¤ºçœ‹æ¿å¨˜æ¶ˆæ¯
live2d_settings['showF12OpenMsg'] = true;         // æ˜¾ç¤ºæŽ§åˆ¶å°æ‰“å¼€æç¤º
live2d_settings['showCopyMessage'] = true;         // æ˜¾ç¤º å¤åˆ¶å†…å®¹ æç¤º
live2d_settings['showWelcomeMessage'] = true;         // æ˜¾ç¤ºè¿›å…¥é¢é¡µæ¬¢è¿Žè¯

//çœ‹æ¿å¨˜æ ·å¼è®¾ç½®
live2d_settings['waifuSize'] = '280x250';    // çœ‹æ¿å¨˜å¤§å°ï¼Œä¾‹å¦‚ '280x250', '600x535'
live2d_settings['waifuTipsSize'] = '250x70';     // æç¤ºæ¡†å¤§å°ï¼Œä¾‹å¦‚ '250x70', '570x150'
live2d_settings['waifuFontSize'] = '12px';       // æç¤ºæ¡†å­—ä½“ï¼Œä¾‹å¦‚ '12px', '30px'
live2d_settings['waifuToolFont'] = '14px';       // å·¥å…·æ å­—ä½“ï¼Œä¾‹å¦‚ '14px', '36px'
live2d_settings['waifuToolLine'] = '20px';       // å·¥å…·æ è¡Œé«˜ï¼Œä¾‹å¦‚ '20px', '36px'
live2d_settings['waifuToolTop'] = '0px'         // å·¥å…·æ é¡¶éƒ¨è¾¹è·ï¼Œä¾‹å¦‚ '0px', '-60px'
live2d_settings['waifuMinWidth'] = '768px';      // é¢é¡µå°äºŽ æŒ‡å®šå®½åº¦ éšè—çœ‹æ¿å¨˜ï¼Œä¾‹å¦‚ 'disable'(ç¦ç”¨), '768px'
live2d_settings['waifuEdgeSide'] = 'left:0';     // çœ‹æ¿å¨˜è´´è¾¹æ–¹å‘ï¼Œä¾‹å¦‚ 'left:0'(é å·¦ 0px), 'right:30'(é å³ 30px)
live2d_settings['waifuDraggable'] = 'disable';    // æ‹–æ‹½æ ·å¼ï¼Œä¾‹å¦‚ 'disable'(ç¦ç”¨), 'axis-x'(åªèƒ½æ°´å¹³æ‹–æ‹½), 'unlimited'(è‡ªç”±æ‹–æ‹½)
live2d_settings['waifuDraggableRevert'] = true;         // æ¾å¼€é¼ æ ‡è¿˜åŽŸæ‹–æ‹½ä½ç½®ï¼Œå¯é€‰ true(çœŸ), false(å‡)

// å…¶ä»–æ‚é¡¹è®¾ç½®
live2d_settings['l2dVersion'] = '1.4.2';        // å½“å‰ç‰ˆæœ¬
live2d_settings['l2dVerDate'] = '2018.11.12'; // ç‰ˆæœ¬æ›´æ–°æ—¥æœŸ
live2d_settings['homePageUrl'] = 'auto';       // ä¸»é¡µåœ°å€ï¼Œå¯é€‰ 'auto'(è‡ªåŠ¨), '{URL ç½‘å€}'
live2d_settings['aboutPageUrl'] = 'http://lchub.icu';   // å…³äºŽé¡µåœ°å€, '{URL ç½‘å€}'
live2d_settings['screenshotCaptureName'] = 'live2d.png'; // çœ‹æ¿å¨˜æˆªå›¾æ–‡ä»¶åï¼Œä¾‹å¦‚ 'live2d.png'
...
function loadModel(modelId, modelTexturesId = 0) {
    ...
    loadlive2d('live2d', live2d_settings.modelAPI + 'get/?id=' + modelId + '-' + modelTexturesId, (live2d_settings.showF12Status ? console.log('[Status]', 'live2d', 'æ¨¡åž‹', modelId + '-' + modelTexturesId, 'åŠ è½½å®Œæˆ') : null));
}
...
function loadTipsMessage(result) {
    ...
    /* æ£€æµ‹ç”¨æˆ·æ´»åŠ¨çŠ¶æ€ï¼Œå¹¶åœ¨ç©ºé—²æ—¶æ˜¾ç¤ºä¸€è¨€ */
